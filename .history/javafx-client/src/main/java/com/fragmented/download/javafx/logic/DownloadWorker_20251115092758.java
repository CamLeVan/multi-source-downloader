...
public class DownloadWorker {
    ...
    /**
     * Starts the asynchronous download of a given piece and returns a future that completes
     * when the piece is successfully downloaded and written to storage. This version does not
     * use a success callback and is suitable for awaitable operations.
     *
     * @param piece The piece to download.
    ...
    public CompletableFuture<Void> downloadAndAwait(PieceModel piece) {
        CompletableFuture<Void> completionFuture = new CompletableFuture<>();
        CompletableFuture<byte[]> downloadFuture = downloadClient.downloadPiece(piece);
