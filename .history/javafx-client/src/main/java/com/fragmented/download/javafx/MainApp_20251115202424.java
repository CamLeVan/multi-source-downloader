...
public class MainApp extends Application {
    ...
    /**
     * *** ĐÃ SỬA LỖI 2 (VFS Bug) ***
     * Cập nhật hàm này để nhận fileId và DownloadState (từ RAM)
     */
