...
public class MainApp extends Application {
    ...
    private static final String MANIFEST_URL = "https://localhost:8443/manifest/100MB.zip";
    private static final String VFS_MOUNT_DIR = "downloader-vfs";
    private static final String TRACKER_URL = "http://localhost:8081"; // Default tracker URL
    ...
    public void startDownload(String manifestUrl) {
        try {
            ...
            // 12. Periodically refresh peer list (background thread)
